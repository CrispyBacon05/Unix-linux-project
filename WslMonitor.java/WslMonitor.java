...
public class WslMonitor {
    ...
    // global vars to remember the last loop's numbers
    static long oldTotalCpu = 0;
    static long oldIdleCpu = 0;
    static long oldRx = 0;
    static long oldTx = 0;

    public static void main(String[] args) throws Exception { // just throw exception to avoid try/catch everywhere
        
        while (true) {
            // I found this on stackoverflow to clear the screen
            System.out.print("\033[H\033[2J");
            
            System.out.println("==================================");
            System.out.println("    MY WSL MONITOR V1.0         ");
            System.out.println("==================================");
            ...
            System.out.println("==================================");
            System.out.println("Press Ctrl+C to stop lol");
    ...
    public static void getCpu() {
        try {
            ...
            // grab all the cpu stats from the array
            ...
            // can't divide by zero on first run
            if (oldTotalCpu != 0) {
        ...
        try {
            ...
            while (scan.hasNextLine()) {
                ...
                if (line.contains("MemTotal:")) {
                    // strip out the "kB" text to just get the numbers
